...
def getLetterCount(message):
    ...
    letterFrequency = {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 0, 'F': 0, 'G': 0, 'H': 0, 'I': 0, 'J': 0, 'K': 0,
...
def frequencyOrder(message):
    letterToFrequency = getLetterCount(message)
    frequencyToLetter = {}
    ...
    for letter in LETTERS:
        if letterToFrequency[letter] not in frequencyToLetter:
            ...
            frequencyToLetter[letterToFrequency[letter][letter]].append(letter)
